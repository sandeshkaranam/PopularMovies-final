...
public class TopRatedFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    final String LOG_TAG = TopRatedFragment.class.getSimpleName();
                ...
                if (dy > 0) //check for scroll down
                {
                    ...
                    if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                        if (loading && pageCount <= 40) {
                            ...
                            Log.v("...", "Last Item Wow !");
                            pageCount++;
                            new CommonAsyncTask(TopRatedFragment.this, Constants.TOP_RATED_REQUEST).execute(Integer.toString(pageCount));
                        }
                    }
                }
            }
    ...
    private void updateMovies() {
        new CommonAsyncTask(this, Constants.TOP_RATED_REQUEST).execute("1");
    }
