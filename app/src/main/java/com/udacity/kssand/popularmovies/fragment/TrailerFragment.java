...
import com.udacity.kssand.popularmovies.adapter.TrailerFragmentAdapter;
 ...
 */
public class TrailerFragment extends android.support.v4.app.ListFragment {
    ...
    public void onTaskCompleted(Object object) {
        if(null!=object) {
            ...
            if(trailerList.size()==0){
                ...
                ((DetailActivityFragment)getParentFragment()).setShareIntent("Watch the trailer - " + Constants.YOU_TUBE_BASE_URL + trailerList.get(0).getKey());
            }
        }else{
